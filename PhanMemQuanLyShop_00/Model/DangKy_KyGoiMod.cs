...
namespace PhanMemQuanLyShop_00.Model
{
    class DangKy_KyGoiMod
    {
        ...
        {
            string sqlSua = "INSERT INTO [ShopChoMeo].[dbo].[ThongTinKyGoi] ([MaThongTinKyGui],[TenChu],[LienHe],[CMND],[TenThuCung],[SoLuong],[NgayGoi],[NgayTra],[GiaComBo],[MaNhanVien],[TenChuong],[GiayTo]) VALUES ('" + maThongTinKyGui + "',N'" + tenChu + "',N'" + lienHe + "','" + cMND + "',N'" + tenThuCung + "','" + soLuong + "',CONVERT(date, '" + ngayGoi + "', 103),CONVERT(date, '" + ngayTra + "', 103),'" + giaComBo + "','" + maNhanVien + "','" + tenChuong + "','" + giayTo + "')";
            bool kt = false;
