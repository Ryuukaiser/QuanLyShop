...
namespace PhanMemQuanLyShop_00.Model
{
    class KhachHangMod
    {
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[KhachHang]";
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[KhachHang] WHERE [TheThanhVien] = '" + loaiThe+"'";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[KhachHang] ([MaKhachHang],[LienHe],[TenDonVi],[TheThanhVien]) VALUES ('" + maKhachHang + "',N'" + LienHe + "', N'" + TenDonVi + "', N'" + TheThanhVien + "')";
            bool kt = false;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[KhachHang] SET [MaKhachHang] = '" + maKhachHang + "',[LienHe] =  N'" + LienHe + "',[TenDonVi] =  N'" + TenDonVi + "',[TheThanhVien] = N'" + TheThanhVien + "' WHERE maKhachHang='" + maKhachHang + "'";
            bool kt = false;
        ...
        {
            string sqlXoa = "DELETE FROM [VitaminHouse].[dbo].[KhachHang] WHERE MaKhachHang='" + maKhachHang + "'";
            bool kt = false;
