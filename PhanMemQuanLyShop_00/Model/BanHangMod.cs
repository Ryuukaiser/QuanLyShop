...
namespace PhanMemQuanLyShop_00.Model
{
    class BanHangMod
    {
        ...
        {
            string sqlSua = " UPDATE [VitaminHouse].[dbo].[HangHoa] SET [MaHang] = '" + maHang + "',[TenHang] = N'" + tenHang + "' ,[DonVi] = N'" + donVi + "' ,[LoaiHang] = N'" + loaiHang + "',[MaChiTietNhap] = '" + maChiTietNhap + "',[GiaBan] = '" + giaBan + "',[SoLuongHang] = '" + soLuongHang + "' WHERE [MaHang] = '" + maHang + "'";
            bool kt = false;
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaHang],[TenHang],[DonVi],[LoaiHang],[GiaBan],[SoLuongHang] FROM [VitaminHouse].[dbo].[HangHoa] WHERE TenHang LIKE N'%" + tenHang + "%'";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            DataTable re;
            string lenh = "SELECT [TenDonVi] FROM [VitaminHouse].[dbo].[KhachHang]";
        ...
        public string LayTenKhach(string tenKhach)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = string.Format("SELECT [MaKhachHang] FROM [VitaminHouse].[dbo].[KhachHang] WHERE [TenDonVi] = N'" + tenKhach + "'");
        ...
        public string LayThongTinLienHe(string tenKhach)
        {
            ConnectToSql con = new ConnectToSql();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = string.Format("SELECT [LienHe] FROM [VitaminHouse].[dbo].[KhachHang] WHERE [TenDonVi] = N'" + tenKhach + "'");
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
            try
            {
        ...
        public string LayThongTinThe(string tenKhach)
        {
            ConnectToSql con = new ConnectToSql();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = string.Format("SELECT [TheThanhVien] FROM [VitaminHouse].[dbo].[KhachHang] WHERE [TenDonVi] = N'" + tenKhach + "'");
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
            try
            {
        ...
        {
            DataTable re;
            string lenh = "SELECT [MaNhanVien] FROM [VitaminHouse].[dbo].[NhanVien]";
            re = KetNoi.DuLieuTable(lenh);
            return re;
        }
        ...
        public string LayTenNhanVien(string maNhanVien)
        {
            ConnectToSql con = new ConnectToSql();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = string.Format("SELECT [HoTen] FROM [VitaminHouse].[dbo].[NhanVien] WHERE [MaNhanVien] = '" + maNhanVien + "'");
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[ChiTietHoaDon] WHERE [MaBanHang] = '" + maBanHang + "'";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[BanHangCombo]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[BanHangCombo] WHERE [MaKhachHang] = '" + maKhach + "'";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[BanHangCombo] ([MaBanHang],[NgayBanHang],[MaKhachHang],[MaNhanVien]) VALUES ('" + maPhieuHang + "',CONVERT(datetime, '" + ngayBan + "', 111),'" + maKhachHang + "','" + maNhanVien + "')";
            bool kt = false;
        ...
        {
            string sqlSua = " UPDATE [VitaminHouse].[dbo].[ChiTietHoaDon] SET [MaChiTietHoaDon] = '" + maChiTietHoaDon + "',[MaBanHang] = '" + maBanHang + "',[MaHang] = '" + maHang + "',[SoLuong] = '" + soLuong + "',[GiaBan] = '" + giaBan + "',[ThanhTien] = '" + thanhTien + "',[TenHang]=N'" + tenHang + "' WHERE [MachiTietHoaDon] = '" + maChiTietHoaDon + "'";
            bool kt = false;
            if (ExecuteNonQuery(sqlSua) > 0)
            {
                kt = true;
