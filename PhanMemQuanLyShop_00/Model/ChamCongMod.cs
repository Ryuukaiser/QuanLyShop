...
namespace PhanMemQuanLyShop_00.Model
{
    class ChamCongMod
    {
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[ChamCong]";
        ...
        {
            MoKetNoi();
            string sql = "SELECT [HoTen] FROM [VitaminHouse].[dbo].[NhanVien]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        public string LayMaNhanVien(string ten)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = string.Format("SELECT [MaNhanVien] FROM [VitaminHouse].[dbo].[NhanVien] WHERE [HoTen] = N'" + ten + "'");
        ...
        {
            string sqlSua = "INSERT INTO [VitaminHouse].[dbo].[ChamCong] ([MaChamCong],[MaNhanVien],[TenNhanVien],[Thang],[Nam],[TangCa],[NghiLam],[LuongCung],[LuongNhan],[TienThuong],[TienPhat]) VALUES ('" + maChamCong + "','" + maNhaVien + "',N'" + tenNhanVien + "','" + thang + "','" + nam + "','" + tangCa + "','" + nghiLam + "','" + luongCung + "','" + luongNhan + "','" + tienThuong + "','" + tienPhat + "')";
            bool kt = false;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[ChamCong] SET [MaChamCong] = '" + maChamCong + "',[MaNhanVien] = '" + maNhaVien + "',[TenNhanVien] = N'" + tenNhanVien + "',[Thang] = '" + thang + "',[Nam] = '" + nam + "',[TangCa] = '" + tangCa + "',[NghiLam] = '" + nghiLam + "',[LuongCung] = '" + luongCung + "',[LuongNhan] = '" + luongNhan + "',[TienThuong] = '" + tienThuong + "',[TienPhat] = '" + tienPhat + "' WHERE [MaChamCong] = '" + maChamCong + "'";
            bool kt = false;
            if (ExecuteNonQuery(sqlSua) > 0)
            {
                kt = true;
        ...
        {
            string sqlSua = "DELETE FROM [VitaminHouse].[dbo].[ChamCong] WHERE [MaChamCong] = '" + maChamCong + "'";
            bool kt = false;
            if (ExecuteNonQuery(sqlSua) > 0)
            {
                kt = true;
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[ChamCong] WHERE Thang ='" + thang + "' AND Nam = '" + nam + "'";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
