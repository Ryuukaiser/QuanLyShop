...
namespace PhanMemQuanLyShop_00.Model
{
    class NhapKhoMod
    {
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[NhapKho]";
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[ChiTietNhapKho]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT * FROM [VitaminHouse].[dbo].[HangHoa]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaNhap] FROM [VitaminHouse].[dbo].[NhapKho]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaNhaCungCap]FROM [VitaminHouse].[dbo].[NhaCungCap]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaChiTietNhap] FROM [VitaminHouse].[dbo].[ChiTietNhapKho]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[NhapKho] ([MaNhap] ,[MaNhaCungCap] ,[NgayNhap]) VALUES ('" + maNhap + "','" + maNhaCungCap + "',CONVERT(datetime, '" + ngayNhap + "', 101))";
            bool kt = false;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[NhapKho] SET [MaNhap] = N'" + maNhap + "',[MaNhaCungCap] = N'" + maNhaCungCap + "' ,[NgayNhap] = CONVERT(datetime, '" + ngayNhap + "', 101) WHERE MaNhap='" + maNhap + "'";
        ...
        {
            string sqlXoa = "DELETE FROM [VitaminHouse].[dbo].[NhapKho] WHERE MaNhap='" + maNhap + "'";
            bool kt = false;
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[ChiTietNhapKho] ([MaChiTietNhap],[GoiHang], [MaNhap], [SoLuong], [GiaNhap]) VALUES ('" + maChiTietNhap + "',N'" + goiHang + "','" + maNhap + "','" + soLuong + "','" + giaNhap + "')";
            bool kt = false;
            if (ExecuteNonQuery(sqlThem) > 0)
            {
                kt = true;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[ChiTietNhapKho] SET [MaChiTietNhap] = '" + maChiTietNhap + "',[GoiHang]=N'" + goiHang + "',[MaNhap] = N'" + maNhap + "' ,[SoLuong] = '" + soLuong + "',[GiaNhap]='" + giaNhap + "' WHERE MaChiTietNhap='" + maChiTietNhap + "'";
        ...
        {
            string sqlXoa = "DELETE FROM [VitaminHouse].[dbo].[ChiTietNhapKho] WHERE  MaChiTietNhap='" + maChiTietNhap + "'";
            bool kt = false;
            if (ExecuteNonQuery(sqlXoa) > 0)
            {
                kt = true;
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[HangHoa]([MaHang],[TenHang],[DonVi],[LoaiHang],[MaChiTietNhap],[Giaban],[SoLuongHang]) VALUES ('" + maHang + "',N'" + tenHang + "',N'" + DonVi + "',N'" + loaiHang + "','" + maChitiet + "','" + giaBan + "','"+soLuong+"')";
            bool kt = false;
            if (ExecuteNonQuery(sqlThem) > 0)
            {
                kt = true;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[HangHoa] SET [MaHang] =N'" + maHang + "',[TenHang] =N'" + tenHang + "',[DonVi] = N'" + donVi + "',[LoaiHang] = N'" + loaiHang + "',[MaChiTietNhap] = '" + maChitiet + "',[GiaBan] = '" + giaBan + "',[SoLuongHang] = '"+soLuong+"' WHERE MaHang='" + maHang + "'";
        ...
        {
            string sqlXoa = "DELETE FROM [VitaminHouse].[dbo].[HangHoa] WHERE MaHang='" + maHang + "'";
            bool kt = false;
            if (ExecuteNonQuery(sqlXoa) > 0)
            {
                kt = true;
