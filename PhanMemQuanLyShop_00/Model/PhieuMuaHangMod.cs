...
namespace PhanMemQuanLyShop_00.Model
{
    class PhieuMuaHangMod
    {
        ...
        {
            string sqlThem = "INSERT INTO [VitaminHouse].[dbo].[BanHangCombo] ([MaBanHang],[NgayBanHang],[MaKhachHang],[MaNhanVien]) VALUES ('" + maPhieuHang + "',CONVERT(datetime, '" + ngayBan + "', 101),'" + maKhachHang + "','" + maNhanVien + "')";
            bool kt = false;
        ...
        {
            string sqlSua = "UPDATE [VitaminHouse].[dbo].[BanHangCombo] SET [MaBanHang] =  '" + maPhieuHang + "',[NgayBanHang] =  CONVERT(datetime, '" + ngayBan + "', 101),[MaKhachHang] =  '" + maKhachHang + "',[MaNhanVien] =  '" + maNhanVien + "' WHERE MaBanHang='" + maPhieuHang + "'";
            bool kt = false;
        ...
        {
            string sqlXoa = "DELETE FROM [VitaminHouse].[dbo].[BanHangCombo] WHERE MaBanHang='" + maPhieu + "'";
            bool kt = false;
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaKhachHang] FROM [VitaminHouse].[dbo].[KhachHang]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
        ...
        {
            MoKetNoi();
            string sql = "SELECT [MaNhanVien] FROM [VitaminHouse].[dbo].[NhanVien]";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            DongKetNoi();
